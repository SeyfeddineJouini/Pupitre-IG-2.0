            ...
            <main className="flex-grow flex flex-col sm:flex-col ml-auto ">
              ...
              <div className="flex justify-center flex-wrap border border-gray-300 shadow-md mb-5">
                ...
                <div className="flex-grow flex-shrink flex-auto max-w-[300px]">
                  ...
                  <div className="bg-cool-gray050 flex items-center p-[16px] relative self-stretch w-full flex-[0_0_auto]">
                    <div className="relative w-[370px] h-[22px] mt-[-1.00px] mr-[-29.00px] [font-family:'Inter',Helvetica] font-light text-cool-gray900 text-[14px] tracking-[0] leading-[21px] whitespace-nowrap">
                    {stats.length > 1 && stats[1] && <p>{parseFloat(stats[1].scoreTotal).toFixed(3)}</p>}
                    </div>
                  </div>
                  <div className="bg-cool-gray050 flex items-center p-[16px] relative self-stretch w-full flex-[0_0_auto]">
                    <div className="relative w-[370px] h-[22px] mt-[-1.00px] mr-[-29.00px] [font-family:'Inter',Helvetica] font-light text-cool-gray900 text-[14px] tracking-[0] leading-[21px] whitespace-nowrap">
                    {stats.length > 2 && stats[2] && <p>{parseFloat(stats[2].scoreTotal).toFixed(3)}</p>}
                    </div>
                  </div>
                </div>
                <div className="flex-grow flex-shrink flex-auto max-w-[300px]">
                  ...
                  <div className="bg-cool-gray050 flex items-center p-[16px] relative self-stretch w-full flex-[0_0_auto]">
                    <div className="relative w-[370px] h-[22px] mt-[-1.00px] mr-[-29.00px] [font-family:'Inter',Helvetica] font-light text-cool-gray900 text-[14px] tracking-[0] leading-[21px] whitespace-nowrap">
                    {stats.length > 0 && stats[0] && <p style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', width: '230px' }}>{stats[0].spe}</p>}
                    </div>
                  </div>
                  <div className="bg-cool-gray050 flex items-center p-[16px] relative self-stretch w-full flex-[0_0_auto]">
                    <div className="relative w-[370px] h-[22px] mt-[-1.00px] mr-[-29.00px] [font-family:'Inter',Helvetica] font-light text-cool-gray900 text-[14px] tracking-[0] leading-[21px] whitespace-nowrap">
                    {stats.length > 1 && stats[1] && <p style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', width: '230px' }}>{stats[1].spe}</p>}
                    </div>
                  </div>
                  <div className="bg-cool-gray050 flex items-center p-[16px] relative self-stretch w-full flex-[0_0_auto]">
                    <div className="relative w-[370px] h-[22px] mt-[-1.00px] mr-[-29.00px] [font-family:'Inter',Helvetica] font-light text-cool-gray900 text-[14px] tracking-[0] leading-[21px] whitespace-nowrap">
                    {stats.length > 2 && stats[2] && <p style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', width: '230px' }}>{stats[2].spe}</p>}
                    </div>
                  </div>
                </div>
                <div className="flex-grow flex-shrink flex-auto max-w-[300px]">
